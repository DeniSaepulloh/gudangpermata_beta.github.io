...
import 'schema/produk_record.dart';
...
export 'schema/produk_record.dart';
export 'schema/video_record.dart';

/// Functions to query ProdukRecords (as a Stream and as a Future).
Stream<List<ProdukRecord>> queryProdukRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ProdukRecord.collection,
...
Future<List<ProdukRecord>> queryProdukRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<ProdukRecord>> queryProdukRecordPage({
  Query Function(Query)? queryBuilder,
