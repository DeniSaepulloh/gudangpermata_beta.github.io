...
class _$VideoRecord extends VideoRecord {
  ...
  _$VideoRecord._({this.video, this.ffRef}) : super._();
  ...
  bool operator ==(Object other) {
    ...
    return other is VideoRecord && video == other.video && ffRef == other.ffRef;
  }

  @override
  int get hashCode {
    return $jf($jc($jc(0, video.hashCode), ffRef.hashCode));
  }
...
class VideoRecordBuilder implements Builder<VideoRecord, VideoRecordBuilder> {
  ...
  _$VideoRecord _build() {
    final _$result = _$v ?? new _$VideoRecord._(video: video, ffRef: ffRef);
    replace(_$result);
    return _$result;
  }
}
